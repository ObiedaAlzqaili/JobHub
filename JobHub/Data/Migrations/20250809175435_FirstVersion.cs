        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    companyName = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    ImageCompanyBase64 = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ImageCompanyType = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ImageCompanyName = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    Location = table.Column<string>(type: "nvarchar(max)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ResumeBase64 = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ResumeType = table.Column<string>(type: "nvarchar(max)", nullable: true),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_JobApplications", x => new { x.EndUserId, x.JobPostId });
                    table.ForeignKey(
                        name: "FK_JobApplications_AspNetUsers_EndUserId",
